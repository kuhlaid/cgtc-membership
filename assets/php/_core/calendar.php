<?php
	...
	$dblMinimumDate = '';
	$dblMaximumDate = '';
	if ((array_key_exists("minimumDate", $_GET)) || ($_GET["minimumDate"])) {
		$dblMinimumDate = $_GET["minimumDate"];
	}
	if ((array_key_exists("maximumDate", $_GET)) || ($_GET["maximumDate"])) {
		$dblMaximumDate = $_GET["maximumDate"];
	}
	// *************************
	...
	$strQueryArgs = sprintf("&strFormId=%s&strId=%s&minimumDate=%s&maximumDate=%s", $_GET["strFormId"], $_GET["strId"], $dblMinimumDate, $dblMaximumDate);
