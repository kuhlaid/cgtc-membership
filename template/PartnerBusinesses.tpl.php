<?php
	// This is the HTML template include file (.tpl.php) for the partner_business_list.php
	...
	$strPageTitle = __strCGTC_PartnerBusinesses___;
	...
	// if membership admin
	if(checkAccess(1)) {
		$addLink = '<a href="PartnerBusiness.php" class="btn btn-primary">Add a new business</a>';
	}
?>
...
<?php // build the page title and critical links ?>
	<div class="d-flex justify-content-between">
		...
		<?php $this->dtgPartnerBusiness->Render() ?>
</div>
	<?php $this->RenderEnd(); ?>
