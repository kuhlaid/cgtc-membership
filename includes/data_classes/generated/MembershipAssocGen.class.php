<?php
	/**
	 * The abstract MembershipAssocGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the MembershipAssoc subclass which
	 * extends this MembershipAssocGen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the MembershipAssoc class.
	 * 
	 * @package My Application
	 * @subpackage GeneratedDataObjects
	 * 
	 */
	class MembershipAssocGen extends QBaseClass {
		///////////////////////////////
		// COMMON LOAD METHODS
		///////////////////////////////

		/**
		 * Load a MembershipAssoc from PK Info
		 * @param integer $intId
		...
		public static function Load($intId) {
			...
			return MembershipAssoc::QuerySingle(
				QQ::Equal(QQN::MembershipAssoc()->Id, $intId)
			);
		}

		/**
		 * Load all MembershipAssocs
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return MembershipAssoc[]
		 */
		public static function LoadAll($objOptionalClauses = null) {
			// Call MembershipAssoc::QueryArray to perform the LoadAll query
			try {
				return MembershipAssoc::QueryArray(QQ::All(), $objOptionalClauses);
		...
		/**
		 * Count all MembershipAssocs
		 * @return int
		 */
		public static function CountAll() {
			// Call MembershipAssoc::QueryCount to perform the CountAll query
			return MembershipAssoc::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly,$selectionArray = null) {
			...
			// Create/Build out the QueryBuilder object with MembershipAssoc-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'MembershipAssoc');
			MembershipAssoc::GetSelectFields($objQueryBuilder,null,$selectionArray);
			$objQueryBuilder->AddFromItem('`MembershipAssoc` AS `MembershipAssoc`');
		...
		/**
		 * Static Qcodo Query method to query for a single MembershipAssoc object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return MembershipAssoc the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null,$selectionArray = null) {
			...
			try {
				$strQuery = MembershipAssoc::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false,$selectionArray);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}

			// Perform the Query, Get the First Row, and Instantiate a new MembershipAssoc object
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return MembershipAssoc::InstantiateDbRow($objDbResult->GetNextRow());
		}

		/**
		 * Static Qcodo Query method to query for an array of MembershipAssoc objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return MembershipAssoc[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null,$selectionArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return MembershipAssoc::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNodes);
		}

		/**
		 * Static Qcodo Query method to query for a count of MembershipAssoc objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null,$selectionArray = null) {
			// Get the Query Statement
			try {
				$strQuery = MembershipAssoc::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true,$selectionArray);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
...
/*		public static function QueryArrayCached($strConditions, $mixParameterArray = null) {
			...
			$objCache = new QCache('query', 'MembershipAssoc_' . serialize($strConditions));
			if (!($strQuery = $objCache->GetData())) {
				// Not Found -- Go ahead and Create/Build out a new QueryBuilder object with MembershipAssoc-specific fields
				$objQueryBuilder = new QQueryBuilder($objDatabase);
				MembershipAssoc::GetSelectFields($objQueryBuilder);
				MembershipAssoc::GetFromFields($objQueryBuilder);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this MembershipAssoc
		...
		/**
		 * Instantiate a MembershipAssoc from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this MembershipAssoc::InstantiateDbRow in order to perform
		...
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $strExpandAsArrayNodes = null, $objPreviousItem = null) {
			...
			// Create a new instance of the MembershipAssoc object
			$objToReturn = new MembershipAssoc();
			...
			if (!$strAliasPrefix)
				$strAliasPrefix = 'MembershipAssoc__';
		...
		/**
		 * Instantiate an array of MembershipAssocs from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $strExpandAsArrayNodes = null) {
			...
			if ($strExpandAsArrayNodes) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = MembershipAssoc::InstantiateDbRow($objDbRow, null, $strExpandAsArrayNodes, $objLastRowItem);
					if ($objItem) {
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					array_push($objToReturn, MembershipAssoc::InstantiateDbRow($objDbRow));
			}
		...
		/**
		 * Load a single MembershipAssoc object,
		 * by Id Index(es)
		 * @param integer $intId
		 * @return MembershipAssoc
		*/
		...
		/**
		 * Load an array of MembershipAssoc objects,
		...
		*/
		public static function LoadArrayByMembershipLogId($intMembershipLogId, $objOptionalClauses = null) {
			// Call MembershipAssoc::QueryArray to perform the LoadArrayByMembershipLogId query
			try {
		...
		/**
		 * Count MembershipAssocs
		 * by MembershipLogId Index(es)
		 * @param integer $intMembershipLogId
		 * @return int
		*/
		public static function CountByMembershipLogId($intMembershipLogId) {
			// Call MembershipAssoc::QueryCount to perform the CountByMembershipLogId query
		...
		*/
		public static function LoadArrayByPrimaryMember($blnPrimaryMember, $objOptionalClauses = null) {
			// Call MembershipAssoc::QueryArray to perform the LoadArrayByPrimaryMember query
			try {
				return MembershipAssoc::QueryArray(
					QQ::Equal(QQN::MembershipAssoc()->PrimaryMember, $blnPrimaryMember),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByPrimaryMember($blnPrimaryMember) {
			// Call MembershipAssoc::QueryCount to perform the CountByPrimaryMember query
			return MembershipAssoc::QueryCount(
				QQ::Equal(QQN::MembershipAssoc()->PrimaryMember, $blnPrimaryMember)
			);
		}
		...
		*/
		public static function LoadArrayByMemberId($intMemberId, $objOptionalClauses = null) {
			// Call MembershipAssoc::QueryArray to perform the LoadArrayByMemberId query
			try {
				return MembershipAssoc::QueryArray(
					QQ::Equal(QQN::MembershipAssoc()->MemberId, $intMemberId),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByMemberId($intMemberId) {
			// Call MembershipAssoc::QueryCount to perform the CountByMemberId query
			return MembershipAssoc::QueryCount(
				QQ::Equal(QQN::MembershipAssoc()->MemberId, $intMemberId)
			);
		}
		...
		public function Save($blnForceInsert = false, $blnForceUpdate = false) {
			...
			try {
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$mixToReturn = $this->intId = $objDatabase->InsertId('MembershipAssoc', 'Id');
				} else {
			...
			return $mixToReturn;
				...
				/**
		 * Delete this MembershipAssoc
		 * @return void
		*/
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this MembershipAssoc with an unset primary key.');
		...
		*/
		...
		/**
		 * Truncate MembershipAssoc table
		 * @return void
		*/
			...
			switch ($strName) {
				...
				case 'MembershipLogIdObject':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved MembershipLogIdObject for this MembershipAssoc');
				...
				case 'MemberIdObject':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved MemberIdObject for this MembershipAssoc');
		...
		/**
		 * Protected member variable that maps to the database PK Identity column MembershipAssoc.Id
		 * @var integer intId
		 */
		protected $intId;
		...
		/**
		 * Protected member variable that maps to the database column MembershipAssoc.MembershipLogId
		...
		/**
		 * Protected member variable that maps to the database column MembershipAssoc.PrimaryMember
		...
		/**
		 * Protected member variable that maps to the database column MembershipAssoc.MemberId
		 ...
		 * in the database column MembershipAssoc.MembershipLogId.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column MembershipAssoc.MemberId.
		 *
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="MembershipAssoc"><sequence>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('MembershipAssoc', $strComplexTypeArray)) {
				$strComplexTypeArray['MembershipAssoc'] = MembershipAssoc::GetSoapComplexTypeXml();
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, MembershipAssoc::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, MembershipAssoc::GetSoapObjectFromObject($objObject, true));
	...
	class QQNodeMembershipAssoc extends QQNode {
		protected $strTableName = 'MembershipAssoc';
		protected $strPrimaryKey = 'Id';
		protected $strClassName = 'MembershipAssoc';
	...
	class QQReverseReferenceNodeMembershipAssoc extends QQReverseReferenceNode {
		protected $strTableName = 'MembershipAssoc';
		protected $strPrimaryKey = 'Id';
		protected $strClassName = 'MembershipAssoc';
		protected $strDbSchema = '';	// wpg - added so we would have the database schema
