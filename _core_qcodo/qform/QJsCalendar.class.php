<?php
	...
	class QJsCalendar extends QTextBox {
		...
		protected $strDisplayFormat = '%b %d, %Y';
		protected $strQcDisplayFormat = 'MMM DD, YYYY';
		...
		public function __construct($objParentObject, $strControlId = null) {
			...
			$this->strJavaScripts = 'jscalendar/calendar.js?v=3,jscalendar/lang/calendar-'.QJsCalendar::$JsCalendarLang.'.js,jscalendar/calendar-setup.js?v=1';
		...
		protected function GetControlHtml() {
			...
			$strText .= '<img alt="cal" src="'.__IMAGE_ASSETS__.'/calendar.png" class="calendar_img" id="'.$strTriggerId.'" style="cursor: pointer;padding-left:3px;" title="Date selector" onmouseover="this.style.background=\'\';" onmouseout="this.style.background=\'\'" />';
		...
		public function __set($strName, $mixValue) {
			...
			switch ($strName) {
				...
				case "DateTime":
					...
					if (!is_null($dttDate)) {
						$this->hiddenInput->Text = $dttDate->toString(QDateTime::FormatIso);
						$this->Text = $dttDate->toString($this->strQcDisplayFormat);
					} else {
