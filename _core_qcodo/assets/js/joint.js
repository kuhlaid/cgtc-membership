...
joint.shapes.basic.Rect = joint.shapes.basic.Generic.extend({
    ...
    defaults: joint.util.deepSupplement({
        ...
        attrs: {
            ...
            'text': { 'font-size': 14, text: '', 'ref-x': .5, 'ref-y': .5, ref: 'rect', 'y-alignment': 'middle', 'x-alignment': 'middle', fill: 'black', 'font-family': 'Courier, Arial, helvetica, sans-serif' }
        }
...
joint.shapes.basic.Circle = joint.shapes.basic.Generic.extend({
    ...
    defaults: joint.util.deepSupplement({
        ...
        attrs: {
            ...
            'text': { 'font-size': 14, text: '', 'text-anchor': 'middle', 'ref-x': .5, 'ref-y': .5, ref: 'circle', 'y-alignment': 'middle', fill: 'black', 'font-family': 'Courier, Arial, helvetica, sans-serif' }
        }
    }, joint.shapes.basic.Generic.prototype.defaults)
});
...
joint.shapes.basic.Image = joint.shapes.basic.Generic.extend({
    ...
    defaults: joint.util.deepSupplement({
        ...
        type: 'basic.Image',
        attrs: {
            'text': { 'font-size': 14, text: '', 'text-anchor': 'middle', 'ref-x': .5, 'ref-dy': 20, ref: 'image', 'y-alignment': 'middle', fill: 'black', 'font-family': 'Courier, Arial, helvetica, sans-serif' }
        }
    }, joint.shapes.basic.Generic.prototype.defaults)
});
...
joint.shapes.basic.Path = joint.shapes.basic.Generic.extend({
    ...
    defaults: joint.util.deepSupplement({
        ...
        attrs: {
            ...
            'text': { 'font-size': 14, text: '', 'text-anchor': 'middle', 'ref-x': .5, 'ref-dy': 20, ref: 'path', 'y-alignment': 'middle', fill: 'black', 'font-family': 'Courier, Arial, helvetica, sans-serif' }
        }
    }, joint.shapes.basic.Generic.prototype.defaults)
});
