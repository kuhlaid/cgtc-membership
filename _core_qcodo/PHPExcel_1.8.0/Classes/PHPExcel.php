...
/**
 * @abstract Function used for PHPExcel to convert an html table into an array for PHPExcel.
 * @author w. Patrick Gale - 2014
 * @param html table $contents
 * @return string
 */
function tableToArray($contents)
{
	$DOM = new DOMDocument;
	...
	function tdrows($elements)
	{
		...
		{
			if ($str != '')$str .=  ",";
			$str .= '"'.htmlspecialchars($element->nodeValue).'"';	// wpg - needed to convert special characters
		}
		$str = "array(".$str.")";
		return $str;
	}
