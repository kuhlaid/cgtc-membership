<template OverwriteFlag="true" DocrootFlag="false" DirectorySuffix="" TargetDirectory="<%= __PANELBASE_CLASSES__ %>" TargetFileName="<%= $objTable->ClassName %>EditPanelBase.class.php"/>
<?php
	/**
