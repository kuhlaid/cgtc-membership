<template OverwriteFlag="true" DocrootFlag="true" DirectorySuffix="/generated" TargetDirectory="<%= __PANEL_DRAFTS__ %>" TargetFileName="<%= $objTable->ClassName %>ListPanel.tpl.php"/>
<?php
