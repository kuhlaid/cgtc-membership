<template OverwriteFlag="true" DocrootFlag="true" DirectorySuffix="/generated" TargetDirectory="<%= __PANEL_DRAFTS__ %>" TargetFileName="<%=$objTable->ClassName%>EditPanel.tpl.php"/>
<?php
