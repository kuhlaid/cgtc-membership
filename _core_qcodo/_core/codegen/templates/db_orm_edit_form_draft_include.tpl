<template OverwriteFlag="true" DocrootFlag="true" DirectorySuffix="/generated" TargetDirectory="<%= __FORM_DRAFTS__ %>" TargetFileName="<%= QConvertNotation::UnderscoreFromCamelCase($objTable->ClassName) %>_edit.tpl.php"/>
<?php
