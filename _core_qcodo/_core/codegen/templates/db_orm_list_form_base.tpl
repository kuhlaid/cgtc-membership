<template OverwriteFlag="true" DocrootFlag="false" DirectorySuffix="" TargetDirectory="<%= __FORMBASE_CLASSES__ %>" TargetFileName="<%= $objTable->ClassName %>ListFormBase.class.php"/>
<?php
	/**
...
%><% } %>
		...
		protected function dtg<%= $objTable->ClassName %>_Bind() {
			...
			// Set the DataSource to be the array of all <%= $objTable->ClassName %> objects, given the clauses above
