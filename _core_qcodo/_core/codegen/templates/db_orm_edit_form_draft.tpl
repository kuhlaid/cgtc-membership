...
//		protected function Form_Exit() {}
	...
	// generated/<%= QConvertNotation::UnderscoreFromCamelCase($objTable->ClassName) %>_edit.tpl.php as the included HTML template file
	<%= $objTable->ClassName %>EditForm::Run('<%= $objTable->ClassName %>EditForm', 'generated/<%= QConvertNotation::UnderscoreFromCamelCase($objTable->ClassName) %>_edit.tpl.php');
?>