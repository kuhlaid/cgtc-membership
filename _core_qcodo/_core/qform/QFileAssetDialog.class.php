<?php
	class QFileAssetDialog extends QDialogBox {
		...
		public function __construct($objParentObject, $strFileUplaodCallback, $strControlId = null) {
			// Call parent constructor and define FileUploadCallback
			parent::__construct($objParentObject, $strControlId);
			$this->strFileUploadCallback = $strFileUplaodCallback;

			// Setup the Dialog Box, itself
			$this->strTemplate = __QCOREBASE__ . '/assets/php/_core/QFileAssetDialog.tpl.php';
